...
import {
  hirom,
  ROM_CHOICE_POINTER_GRAPHICS_SIZE,
  ROM_COLOR_MATH_SIZE,
  ROM_CURSOR_GRAPHICS_SIZE,
  ...
  ROM_OFFSET_CHOICE_POINTER_GRAPHICS,
  ROM_OFFSET_COLOR_MATH,
  ROM_OFFSET_CURSOR_GRAPHICS,
...
export class ROM {
  ...
  getCursorGraphicsSlice() {
    return new Slice(
      ROM_OFFSET_CURSOR_GRAPHICS,
      this.getArraySlice(
        ROM_OFFSET_CURSOR_GRAPHICS,
        ROM_OFFSET_CURSOR_GRAPHICS + ROM_CURSOR_GRAPHICS_SIZE
      )
    );
  }
  ...
  getMenuPaletteSetSlice() {
    return new Slice(
      ROM_OFFSET_MENU_PALETTES,
      this.getArraySlice(
        ROM_OFFSET_MENU_PALETTES,
        ROM_OFFSET_MENU_PALETTES + ROM_MENU_PALETTES_SIZE
      )
    );
  }

  getChoicePointerGraphicsSlice() {
    return new Slice(
      ROM_OFFSET_CHOICE_POINTER_GRAPHICS,
      this.getArraySlice(
        ROM_OFFSET_CHOICE_POINTER_GRAPHICS,
        ROM_OFFSET_CHOICE_POINTER_GRAPHICS + ROM_CHOICE_POINTER_GRAPHICS_SIZE
      )
    );
  }
}
